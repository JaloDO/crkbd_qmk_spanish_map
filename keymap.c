...
[_QWERTY] = LAYOUT(
    ...
    //|----------------------------------------------------------------------------|          |--------+--------+--------+--------+--------+-----------------------------------------|
        TD(TD_CAPLOCK), KC_A,       KC_S,       KC_D,       KC_F,       KC_G,                   KC_H,       KC_J,       KC_K,           KC_L,           KC_LBRC,    KC_NUBS,
    //---------+--------+--------+--------+--------+-------------------------------|          |--------+------+--------+--------+--------+-------------------------------------------|
        KC_LCTL,        KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,                   KC_N,       KC_M,       KC_COMM,        KC_DOT,         TD(TD_SLA), KC_ENT,
    //---------+--------+--------+--------+--------+--------------+-------------------|   |--------+---------+--------+--------+--------+--------+-----------------------------------|
...
[_LOWER] = LAYOUT(
    ...
    //|----------------------------------------------------------------------------|         |--------------------------------------------------------------------------------------|
        TD(TD_CAPLOCK), XXXXXXX,    XXXXXXX,    XXXXXXX,    KC_VOLU,    XXXXXXX,                ALGR(KC_Q), ALGR(KC_MINS),KC_UP,        XXXXXXX,        XXXXXXX,    RGB_TOG,
    //|----------------------------------------------------------------------------|         |--------------------------------------------------------------------------------------|
        KC_LCTL,        XXXXXXX,    XXXXXXX,    KC_MPRV,    KC_VOLD,     KC_MNXT,               TD(TD_PC),  KC_LEFT,    KC_DOWN,        KC_RGHT,        XXXXXXX,    RGB_MOD,
    //|--------+--------+--------+--------+--------+--------+-------------------------|   |--------+--------+--------+--------+--------+--------+-----------------------------------|
...
[_RAISE] = LAYOUT(
    ...
    //|----------------------------------------------------------------------------|         |--------------------------------------------------------------------------------------|
        KC_F1,          KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,                  KC_MINS,    KC_EQL,     KC_QUOT,        KC_BSLS,        KC_RBRC,     ALGR(KC_BSLS),
    //|----------------------------------------------------------------------------|         |--------------------------------------------------------------------------------------|
        KC_F7,          KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,                 KC_UNDS,    KC_PLUS,    LSFT(KC_QUOT),  LSFT(KC_BSLS),  KC_RCBR,     KC_LCBR,
    //---------+--------+--------+--------+--------+--------------+-------------------|   |--------+---------+--------+--------+--------+--------+----------------------------------|
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_PLUS] = ACTION_TAP_DANCE_DOUBLE(KC_SCLN, LSFT(KC_SCLN)), 
